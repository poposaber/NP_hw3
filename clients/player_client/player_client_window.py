...
class PlayerClientWindow(ClientWindowBase):
    ...
    def __init__(self, host = "127.0.0.1", port = 21354) -> None:
        ...
        self.player_client_window_test_text = customtkinter.CTkLabel(master=self.home_frame, text="testing")
        self.player_client_window_test_text.place(relx=0.5, rely=0.7, anchor=tkinter.CENTER)
